...
static class SelfTest
{
    ...
    public static async Task Run()
    {
        ...
        try
        {
            ...
            foreach(var key in new[]{"../escape","..\\escape","C:\\escape","name:stream","trailing.\\file"}){try{Services.SafeArchivePath(root+Path.DirectorySeparatorChar,key);throw new Exception("Accepted unsafe path: "+key);}catch(InvalidDataException){}}
            Assert(Services.NormalizeDownloadUrl("https://drive.google.com/file/d/abc_123/view")=="https://drive.usercontent.google.com/download?id=abc_123&export=download&confirm=t","Drive URL normalization failed");
